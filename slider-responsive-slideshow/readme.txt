...
* Cannot redeclare is_sr_serialized() Bug fixed.
* Tested plugin for wordpress 6.5.2

= 1.4.3 =

* Multiple gallery on the page issue fixed.
* Tested plugin for wordpress 6.4.3

= 1.4.2 =

* Security Logic Change Fixed.
* Tested plugin for wordpress 6.4.3
...
* vernarability fixed at save time.
* Tested plugin for wordpress 6.4.3
...
* Enhancements: setting layout update
* Bug Fix: Fixed.
...
* Bug Fix: Bootstrap-js Error Fixed.
